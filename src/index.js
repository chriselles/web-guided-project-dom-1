...
const imageFirstCard = document.querySelector('image')
...
arrNavItems.filter(a => a.textContent === "Home")
console.log(result);
...
document.querySelector('img.card-image-top').src = ''
document.querySelector('img.card-image-top').alt = 'dogs'
